...
class QuadraticForm extends Proxy
{
   ...
   public function add(param1:QuadraticForm) : QuadraticForm
   {
      ...
      while(_loc2_ < 3)
      {
         ...
         while(_loc3_ < 3)
         {
            $m[_loc2_][_loc3_] = $m[_loc2_][_loc3_] + param1[_loc2_][_loc3_];
            _loc3_++;
         }
         _loc2_++;
      }
   ...
   public function fromVectorMultiply(param1:Point3D) : QuadraticForm
   {
      ...
      while(_loc2_ < 3)
      {
         ...
         while(_loc3_ < 3)
         {
            $m[_loc2_][_loc3_] = param1[_loc2_] * param1[_loc3_];
            _loc3_++;
         }
         _loc2_++;
      }
   ...
   public function scalar(param1:Number) : QuadraticForm
   {
      ...
      while(_loc2_ < 3)
      {
         ...
         while(_loc3_ < 3)
         {
            $m[_loc2_][_loc3_] = $m[_loc2_][_loc3_] * param1;
            _loc3_++;
         }
         _loc2_++;
      }
   ...
   public function clone() : QuadraticForm
   {
      ...
      while(_loc2_ < 3)
      {
         ...
         while(_loc3_ < 3)
         {
            _loc1_[_loc2_][_loc3_] = $m[_loc2_][_loc3_];
            _loc3_++;
         }
         _loc2_++;
      }
   ...
   public function apply(param1:Point) : Number
   {
      ...
      while(_loc4_ < 3)
      {
         ...
         while(_loc5_ < 3)
         {
            _loc3_ = _loc3_ + _loc2_[_loc4_] * $m[_loc4_][_loc5_] * _loc2_[_loc5_];
            _loc5_++;
         }
         _loc4_++;
      }
