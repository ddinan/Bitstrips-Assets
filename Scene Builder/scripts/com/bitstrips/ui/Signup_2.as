package com.bitstrips.ui
{
   ...
   public final class Signup extends Sprite
   {
      ...
      public function Signup(param1:Remote)
      {
         ...
         ui.optional_mc.addEventListener(MouseEvent.ROLL_OVER,show_popup_real);
         ui.optional_mc.addEventListener(MouseEvent.ROLL_OUT,hide_popup_real);
         ui.optional_mc.buttonMode = true;
         agree = new CheckBox();
         agree.x = 115;
         agree.y = 220;
         addChild(agree);
      ...
      private function set_all(param1:Boolean) : void
      {
         ...
         {
            fields[_loc2_].enabled = param1;
         }
         ui.join_btn.enabled = param1;
         ui.cancel_btn.enabled = param1;
      }
      ...
      private function validate(param1:Boolean = false) : Object
      {
         ...
         {
            _loc2_["confirm"] = "passwords don\'t match";
         }
      ...
      {
         trace("Username return: " + param1["email"] + ", " + param1["used"]);
         if(param1["used"] == 1)
         {
      ...
      private function join(param1:Event) : void
      {
         ...
         {
            trace("Doing it!");
            remote.new_user(ui.username.text,ui.email.text,ui.password.text,ui.real_name.text,joined);
            set_all(false);
            ui.real_name.enabled = false;
         }
      }
