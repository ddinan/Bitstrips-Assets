package com.bitstrips.comicbuilder
{
   ...
   public class ComicPanel extends Sprite
   {
      ...
      public function ComicPanel(param1:Comic, param2:ComicStrip, param3:Object, param4:Boolean)
      {
         ...
         content.addEventListener(Event.SELECT,select_panel);
         ...
         popped_blocker.addEventListener(MouseEvent.DOUBLE_CLICK,pop_back_handler);
      ...
      public function getAssetByNaeme(param1:String) : ComicAsset
      {
         return content.getAssetByName(param1);
      }
      ...
      public function set panel_width(param1:Number) : void
      {
         ...
         var _loc2_:Number = param1 - panelData.width;
         if(_loc2_)
         {
            panelData.width = param1;
            content.x = content.x + _loc2_ / 2;
            drawMe();
            this.content.panel_width = param1 / content.scaleX - 5;
            this.text_content.panel_width = param1 / text_content.scaleX - 5;
         }
      ...
      private function content_down(param1:MouseEvent) : void
      {
         ...
         update_move_points();
         stage.addEventListener(MouseEvent.MOUSE_MOVE,content_move);
         stage.addEventListener(MouseEvent.MOUSE_UP,content_up);
         if(_selected)
         {
            return;
         }
      ...
      public function load_state(param1:Object) : void
      {
         ...
         drawMe();
         content.addEventListener(MouseEvent.MOUSE_OVER,panel_over);
         content.addEventListener(MouseEvent.ROLL_OUT,panel_out);
         this.blank = false;
      }
   }
}
