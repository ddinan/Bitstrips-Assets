package com.bitstrips.character.skeleton
{
   ...
   public class SkeletonBuddy extends Skeleton implements IBody
   {
      ...
      public function SkeletonBuddy(param1:HeadBase, param2:ArtLoader, param3:Object = undefined, param4:Boolean = true)
      {
         ...
         _head = param1;
         this.addEventListener(SkeletonEvent.LEG_FLIP,flip_leg);
      }
      ...
      override public function init() : void
      {
         ...
         get_bone("thighR").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler);
         get_bone("thighL").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler);
         get_bone("shinR").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler);
         get_bone("shinL").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler);
         get_bone("spine_1").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler);
         ...
         if(BSConstants.STICKMAN)
         {
            add_clothing("stickman");
         }
         else
         {
            add_clothing("bare");
         ...
         _controller.init();
         addChild(_interface);
         this.addEventListener(SkeletonEvent.CHAR_ROT_CHANGE,manage_hands_handler);
         this.addEventListener(SkeletonEvent.CHAR_HEIGHT_CHANGE,manage_hands_handler);
         this.addEventListener(SkeletonEvent.CHAR_TYPE_CHANGE,manage_hands_handler);
         this.addEventListener(SkeletonEvent.CHAR_SEX_CHANGE,manage_hands_handler);
         ...
         (bone_lookup["head"] as Bone).addEventListener(SkeletonEvent.BONE_ROT_CHANGE,do_head_tilt);
      }
