package com.bitstrips.character.skeleton
{
   ...
   public class Skeleton extends Sprite
   {
      ...
      private var _adjusted_float:Number = 0;
      ...
      public function init() : void
      {
         ...
         if(_head)
         {
            ...
            _head.addEventListener("ROTATION",rotate_head_handler);
         }
      }
            ...
            while(_loc4_ < Sprite(_loc2_[_loc3_].clip).numChildren)
            {
               ...
               if(!(_loc5_ is Head || _loc5_ is HeadPiece))
               {
                  if(_edit)
                  {
                     ...
                     _loc5_.addEventListener(MouseEvent.CLICK,art_piece_click);
                  }
                  else
                  {
      ...
      protected function assume_pose(param1:Pose) : void
      {
         ...
         {
            bones[_loc5_].addEventListener(SkeletonEvent.BONE_ROT_CHANGE,update_pose_angle);
            _loc5_++;
         }
         if(_pose.skin_stack)
         {
      ...
      public function add_clothing(param1:String, param2:Boolean = false) : void
      {
         ...
         if(art_loader.clothing_loaded(param1) == false)
         {
            if(waiting_clothes.indexOf(param1) == -1)
            {
               art_loader.clothing_queue(param1,this);
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            _loc7_ = art_loader.get_art("new_body",_loc6_ + "_" + param1);
            if(_loc7_)
            {
               ...
               if(_edit)
               {
                  ...
                  _loc7_.addEventListener(MouseEvent.CLICK,art_piece_click);
               }
            }
      ...
      public function update_colours() : void
      {
         ...
         var _loc1_:Array = _skin.get_skin_pieces();
         var _loc2_:uint = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = 0;
            while(_loc3_ < Sprite(_loc1_[_loc2_].clip).numChildren)
            {
               _loc4_ = _loc1_[_loc2_].clip.getChildAt(_loc3_);
               if(!(_loc4_ is Head || _loc4_ is HeadPiece))
               {
                  cld.colour_clip(_loc4_);
               }
               _loc3_++;
            }
            _loc2_++;
      ...
      public function set body_height(param1:uint) : void
      {
         ...
         while(_loc2_ < bones.length)
         {
            bones[_loc2_].length = LengthData[bones[_loc2_].type][_body_height];
            _loc2_++;
         }
         update_offset_positions();
      ...
      protected function update_offset_positions() : void
      {
         ...
         {
            bone_structures[_loc1_].position = Utils.clone(PointData.data[bone_structures[_loc1_].pos_name][body_type][body_height][body_rotation]);
            if(Skeleton.debug)
            {
