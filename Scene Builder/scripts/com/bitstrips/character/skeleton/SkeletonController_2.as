   ...
   public class SkeletonController
   {
      ...
      public function update_skin_listeners() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            while(_loc5_ < _loc2_.numChildren)
            {
               ...
               {
                  _loc3_.addEventListener(MouseEvent.CLICK,skin_patch_click);
      ...
      public function enable_bone_control(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            if(_skeleton.stage)
            {
               _skeleton.stage.addEventListener(MouseEvent.DOUBLE_CLICK,skin_doubleclick);
            }
            _loc5_ = 0;
            while(_loc5_ < _loc2_.length)
            {
               ...
               _loc4_.addEventListener(MouseEvent.MOUSE_OVER,_loc3_.bone_over);
               _loc4_.addEventListener(MouseEvent.MOUSE_OUT,_loc3_.bone_out);
               _loc4_.addEventListener(MouseEvent.MOUSE_DOWN,_loc3_.bone_down);
               _loc4_.addEventListener(MouseEvent.MOUSE_MOVE,_loc3_.bone_move_around);
               _loc4_.addEventListener(MouseEvent.CLICK,_loc3_.bone_click);
               _loc4_.addEventListener(MouseEvent.MOUSE_DOWN,select_skin);
               _loc3_.addEventListener("bone_over",bone_over);
               _loc3_.addEventListener("bone_out",bone_out);
               _loc3_.addEventListener("bone_down",bone_down);
               _loc3_.addEventListener("bone_up",bone_up);
               _loc3_.addEventListener("bone_move_around",bone_move_around);
               if(_skeleton.stage)
               {
                  _skeleton.stage.addEventListener(MouseEvent.MOUSE_MOVE,bone_detector);
               }
               _loc5_++;
            }
         }
         ...
         {
            _skeleton.addEventListener(MouseEvent.DOUBLE_CLICK,skin_doubleclick);
            if(_skeleton.stage)
            {
      ...
      private function bone_detector(param1:MouseEvent) : void
      {
         ...
         if(_loc3_ && !showing_hidden_bicep)
         {
            ...
            {
               _loc2_[_loc4_].clip.addEventListener(MouseEvent.MOUSE_DOWN,_skeleton.get_bone(_loc5_).bone_down);
               _loc4_++;
            }
            ...
            hidden_stuff.addEventListener(MouseEvent.MOUSE_DOWN,_skeleton.get_bone(_loc5_).bone_down);
      ...
      private function bone_down(param1:Event) : void
      {
         ...
         _skeleton.stage.addEventListener(MouseEvent.MOUSE_UP,bone_up);
         _skeleton.stage.addEventListener(MouseEvent.MOUSE_MOVE,bone_move);
         param1.stopImmediatePropagation();
         draw_bone_graphic(selected_bone,bone_interface_clip);
