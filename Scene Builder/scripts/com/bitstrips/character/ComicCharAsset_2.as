package com.bitstrips.character
{
   ...
   public class ComicCharAsset extends ComicAsset
   {
      ...
      public function ComicCharAsset(param1:String)
      {
         ...
         edit_control_clip.addEventListener(MouseEvent.MOUSE_OVER,editing_override_over,false,99);
         edit_control_clip.addEventListener(MouseEvent.MOUSE_OUT,editing_override_out);
         super();
      }
      ...
      public function loaded(param1:Number, param2:SkeletonBuddy) : void
      {
         if(debug)
         {
      ...
      override public function set editing(param1:Boolean) : void
      {
         ...
         container.filters = new Array(glow);
         ...
         if(editing)
         {
            ...
            position_edit_control_clip();
            size_edit_control_clip();
            body.addEventListener("body rotate",body_rotate_handler);
            SkeletonEvent.CHAR_ROT_CHANGE;
            body.skin.addEventListener(SkeletonEvent.SKIN_RESTACK,body_rotate_handler);
            body.addEventListener(Event.CHANGE,skeleton_change_handler);
         }
