package fl.controls
{
   ...
   public class ComboBox extends UIComponent implements IFocusManagerComponent
   {
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         param1.stopPropagation();
         _loc2_ = Math.max(calculateAvailableHeight() / list.rowHeight << 0,1);
         _loc3_ = selectedIndex;
         _loc4_ = highlightedCell == -1?Number(selectedIndex):Number(highlightedCell);
         _loc5_ = -1;
         switch(param1.keyCode)
         {
            case Keyboard.SPACE:
      ...
      protected function drawLayout() : void
      {
         ...
         _loc1_ = getStyleValue("buttonWidth") as Number;
      ...
      protected function drawTextFormat() : void
      {
         ...
         _loc1_ = getStyleValue(!!_enabled?"textFormat":"disabledTextFormat") as TextFormat;
         if(_loc1_ == null)
         {
