package com.bitstrips.core
{
   ...
   public final class ArtLoader extends EventDispatcher
   {
      ...
      public static function clothing_url(param1:String, param2:String = "buddy") : String
      {
         ...
         return "http://bitstrips.com/tester/parts/" + param2 + "/" + param1 + ".swf";
      }
      
      public function get_clip(param1:String) : MovieClip
      {
         if(clips.hasOwnProperty(param1) == false)
         {
            return null;
         }
         return new clips[param1]();
      }
      
      public function clothing_queue(param1:String, param2:Skeleton = null, param3:String = "buddy") : void
      {
         if(_clothing_queue.hasOwnProperty(param3) == false)
         {
            _clothing_queue[param3] = {};
         }
         if(_clothing_queue[param3].hasOwnProperty(param1) == false)
         {
            _clothing_queue[param3][param1] = [];
            this.load_swf(ArtLoader.clothing_url(param1,param3));
         }
         if(param2)
         {
            _clothing_queue[param3][param1].push(param2);
         }
      }
      ...
      {
         if(_clothing_loaded.hasOwnProperty(param2))
         {
            return _clothing_loaded[param2].hasOwnProperty(param1);
         }
         return false;
      }
      ...
      private function import_art(param1:Event) : void
      {
         ...
         if(_loc6_.hasOwnProperty("type"))
         {
            ...
            if(body_art[_loc10_] == undefined)
            {
               body_art[_loc10_] = {};
            }
            if(body_art[_loc10_][_loc11_] == undefined)
            {
               body_art[_loc10_][_loc11_] = new Array();
            }
            _loc7_ = body_art[_loc10_][_loc11_];
         }
         else
         {
            _loc7_ = art;
         ...
         else
         {
            ...
            clips[_loc12_] = _loc5_.contentLoaderInfo.applicationDomain.getDefinition(_loc12_) as Class;
            if(_clip_queue.hasOwnProperty(_loc12_) == true)
            {
               _loc13_ = 0;
               while(_loc13_ < _clip_queue[_loc12_].length)
               {
                  _clip_queue[_loc12_][_loc13_](this.get_clip(_loc12_));
                  _clip_queue[_loc12_][_loc13_] = null;
                  _loc13_++;
               }
               _clip_queue[_loc12_] = null;
            }
         }
         ...
         if(_loc6_.hasOwnProperty("levels"))
         {
            ...
            {
               levels[_loc14_] = _loc6_.levels[_loc14_];
            }
         }
         ...
         {
            _loc15_ = url_basefile(param1.target.url.url);
            _loc15_ = _loc15_.replace(".swf","");
            if(_clothing_loaded.hasOwnProperty(_loc9_) == false)
            {
               _clothing_loaded[_loc9_] = {};
            }
            _clothing_loaded[_loc9_][_loc15_] = true;
            if(_clothing_queue[_loc9_] && _clothing_queue[_loc9_].hasOwnProperty(_loc15_) == true)
            {
               _loc13_ = 0;
               while(_loc13_ < _clothing_queue[_loc9_][_loc15_].length)
               {
                  _loc16_ = _clothing_queue[_loc9_][_loc15_][_loc13_];
                  _loc16_.add_clothing(_loc15_);
                  _clothing_queue[_loc9_][_loc15_][_loc13_] = null;
                  _loc13_++;
               }
               _clothing_queue[_loc9_][_loc15_] = null;
            }
         }
      }
      ...
      {
         return clips.hasOwnProperty(param1);
      }
      ...
      {
         if(_clip_queue.hasOwnProperty(param1) == false)
         {
            _clip_queue[param1] = [];
            this.load_swf(ArtLoader.clothing_url(param1));
         }
         _clip_queue[param1].push(param2);
      }
