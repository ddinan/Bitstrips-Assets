      ...
      public function clickAssetTest(param1:MouseEvent) : void
      {
         ...
         if(editable)
         {
            ...
            if(_loc3_)
            {
               ...
               {
                  _loc4_ = false;
                  stage.addEventListener(MouseEvent.MOUSE_MOVE,deselectLockedAsset,false,0,true);
                  stage.addEventListener(MouseEvent.MOUSE_UP,deselectLockedAsset_remove,false,0,true);
               }
            }
            if(!_loc4_ && editable)
            {
