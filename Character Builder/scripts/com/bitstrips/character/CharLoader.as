package com.bitstrips.character
{
   ...
   public class CharLoader extends EventDispatcher
   {
      ...
      public function CharLoader(param1:Remote, param2:Boolean = false)
      {
         ...
         dat_loader.addEventListener(BulkLoader.ERROR,bulk_error);
      ...
      public function get_char_asset(param1:String, param2:DisplayObject, param3:int = -1) : ComicCharAsset
      {
         ...
         get_char(param1,_loc4_.loaded_body,param3);
         return _loc4_;
      }
      ...
      public function new_char(param1:String) : SkeletonBuddy
      {
         ...
         return new_char_from_data(dat_loader.get_char_data(param1));
      }
      ...
      {
         remote.log_error("BulkLoader Error " + param1.text.substr(7),param1.text);
      ...
      public function new_char_from_data(param1:Object) : SkeletonBuddy
      {
         ...
         if(param1.hasOwnProperty("head_type") && param1["head_type"] != "Buddy")
         {
            ...
            if(art_loader.clip_loaded(_loc6_) == true)
            {
               (_loc4_ as HeadStick).set_clip(art_loader.get_clip(_loc6_));
            }
            else
            {
               art_loader.clip_queue(_loc6_,(_loc4_ as HeadStick).set_clip);
            }
         }
         else
         {
         ...
         _loc5_ = new SkeletonBuddy(_loc4_,art_loader,param1["body"]);
         if(param1["user_id"])
         {
