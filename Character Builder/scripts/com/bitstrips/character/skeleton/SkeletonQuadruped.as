package com.bitstrips.character.skeleton
{
   ...
   public class SkeletonQuadruped extends Skeleton
   {
      ...
      public function setup_legs() : void
      {
         var _loc1_:uint = 0;
         _loc1_ = 0;
         while(_loc1_ < front_legs.length)
         {
            front_legs[_loc1_].bones[0].set_position(new Point(0,0),front_legs[_loc1_].starting_rot);
            _loc1_++;
         }
         _loc1_ = 0;
         while(_loc1_ < back_legs.length)
         {
            back_legs[_loc1_].bones[0].set_position(new Point(0,0),back_legs[_loc1_].starting_rot);
            _loc1_++;
         }
      }
      ...
      public function align_back_legs() : void
      {
         ...
         var _loc6_:uint = 0;
         while(_loc6_ < back_legs.length)
         {
            _loc1_ = back_legs[_loc6_];
            ...
            _loc1_.bones[0].set_position(_loc5_,_loc4_ + back_legs[_loc6_].starting_rot);
            _loc6_++;
         }
      }
      ...
      public function align_front_legs() : void
      {
         ...
         var _loc4_:Number = _loc2_.bones[0].rotation - _loc2_.starting_rot;
         var _loc6_:uint = 0;
         while(_loc6_ < front_legs.length)
         {
            _loc1_ = front_legs[_loc6_];
            _loc5_ = new Point(_loc1_.position[0],_loc1_.position[1]);
            m.identity();
            m.rotate(_loc4_ * Math.PI / 180);
            m.translate(_loc3_.x,_loc3_.y);
            _loc5_ = m.transformPoint(_loc5_);
            _loc1_.bones[0].set_position(_loc5_,_loc4_ + front_legs[_loc6_].starting_rot);
            _loc6_++;
         }
      }
   }
