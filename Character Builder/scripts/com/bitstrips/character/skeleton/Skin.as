package com.bitstrips.character.skeleton
{
   ...
   public class Skin extends Sprite
   {
      ...
      public function Skin(param1:Skeleton)
      {
         ...
         _skeleton = param1;
         _skeleton.addEventListener(SkeletonEvent.CHAR_SEX_CHANGE,update_frame_handler,false,0,true);
         _skeleton.addEventListener(SkeletonEvent.CHAR_BREASTS_CHANGE,update_frame_handler,false,0,true);
         _skeleton.addEventListener(SkeletonEvent.CHAR_CLOTHES_CHANGE,update_frame_handler,false,0,true);
         _skeleton.addEventListener(SkeletonEvent.CHAR_TYPE_CHANGE,update_frame_handler,false,0,true);
         _skeleton.addEventListener(SkeletonEvent.CHAR_HEIGHT_CHANGE,update_frame_handler,false,0,true);
         _skeleton.addEventListener(SkeletonEvent.CHAR_ROT_CHANGE,update_frame_handler,false,0,true);
         _skeleton.addEventListener(SkeletonEvent.CHAR_ROT_CHANGE,update_stack_handler,false,0,true);
         _skeleton.addEventListener(SkeletonEvent.CHAR_ROT_CHANGE,update_head_rot_handler,false,0,true);
      ...
      public function render() : void
      {
         ...
         while(_loc1_ < _loc6_.length)
         {
            ...
            _loc7_.addEventListener(SkeletonEvent.BONE_POS_CHANGE,update_position_handler,false,0,true);
            _loc7_.addEventListener(SkeletonEvent.BONE_ASPECT_CHANGE,update_bend_handler,false,0,true);
            _loc1_++;
         }
      ...
      {
         if(_skeleton is SkeletonQuadruped)
         {
            return;
         }
         if(debug)
      ...
      public function add_skin_layer(param1:String, param2:DisplayObjectContainer) : void
      {
         ...
         if(piece_name == "footL" || piece_name == "footR" || piece_name == "foot_topL" || piece_name == "foot_topR")
         {
            ...
            _skeleton.addEventListener(SkeletonEvent.CHAR_ROT_CHANGE,toe_bit.flip,false,0,true);
         }
         ...
         if(piece_name == "control_zone")
         {
            ...
            trace(clip.getChildIndex(rotation_zone));
         }
      }
      ...
      public function restack(param1:Array) : void
      {
         ...
         {
            _loc6_ = _skeleton.pose.default_skin_stack[_skeleton.body_rotation];
         }
