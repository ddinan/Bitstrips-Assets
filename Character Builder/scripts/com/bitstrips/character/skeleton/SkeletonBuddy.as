package com.bitstrips.character.skeleton
{
   ...
   public class SkeletonBuddy extends Skeleton implements IBody
   {
      ...
      {
         _hands = new Array(2);
         skirt_mask = new Sprite();
         skirt_mask_test = new Sprite();
         super(param1,param2,param3,param4);
         _point_data_source = PointDataBuddy;
         _length_data_source = LengthDataBuddy;
         _head = param1;
         this.addEventListener(SkeletonEvent.LEG_FLIP,flip_leg,false,0,true);
         species = "buddy";
      }
      ...
      override public function init() : void
      {
         ...
         super.init();
         _pose = new Pose(null,SkeletonBuddy.pose_defaults);
         arms = new Array();
         legs = new Array();
         var _loc1_:Object = {
            "name":"spine",
         ...
         get_bone("thighR").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler,false,0,true);
         get_bone("thighL").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler,false,0,true);
         get_bone("shinR").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler,false,0,true);
         get_bone("shinL").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler,false,0,true);
         get_bone("spine_1").addEventListener(SkeletonEvent.BONE_POS_CHANGE,manage_skirt_handler,false,0,true);
         _head.mouseChildren = false;
         _hands[0] = art_loader.get_art("new_body","hand_bare");
         _hands[1] = art_loader.get_art("new_body","hand_bare");
         var _loc7_:Object = {
         ...
         _head.head_back.y = _head.head_back.y + head_adjustment;
         ...
         _controller.init();
         addChild(_interface);
         this.addEventListener(SkeletonEvent.CHAR_ROT_CHANGE,manage_hands_handler,false,0,true);
         this.addEventListener(SkeletonEvent.CHAR_HEIGHT_CHANGE,manage_hands_handler,false,0,true);
         this.addEventListener(SkeletonEvent.CHAR_TYPE_CHANGE,manage_hands_handler,false,0,true);
         this.addEventListener(SkeletonEvent.CHAR_SEX_CHANGE,manage_hands_handler,false,0,true);
         ...
         addChild(skirt_mask);
         _skin.get_skin_piece("skirt_base").clip.mask = skirt_mask;
         ...
         (bone_lookup["head"] as Bone).addEventListener(SkeletonEvent.BONE_ROT_CHANGE,do_head_tilt,false,0,true);
         this.stance = 1;
      }
      ...
      {
         var _loc1_:uint = 0;
         while(_loc1_ < arms.length)
         {
            arms[_loc1_].bones[0].set_position(new Point(0,0),arms[_loc1_].starting_rot);
            _loc1_++;
         }
      }
      ...
      public function align_legs() : void
      {
         ...
         while(_loc6_ < legs.length)
         {
            ...
            _loc1_.bones[0].set_position(_loc5_,_loc4_ + legs[_loc6_].starting_rot);
            _loc6_++;
         }
      }
      ...
      public function simple_stack_report() : Object
      {
         ...
         if(_skin.selected_skin_piece)
         {
            _loc1_ = _skin.selected_skin_piece.stack_group;
            return {
               "up":simple_bone_up_report(_loc1_),
               "down":simple_bone_down_report(_loc1_)
            };
         }
         return {
            "up":false,
      ...
      {
         return SkeletonBuddy.pose_defaults;
      }
      ...
      private function combined_gesture_stance_adjustments(param1:Object, param2:Object) : Object
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc3_:Object = filter_adjustment(Utils.clone(param2),PoseType.STANCE);
         var _loc4_:Object = filter_adjustment(Utils.clone(param1),PoseType.GESTURE);
         for(_loc5_ in _loc4_)
         {
            if(_loc5_.indexOf("rotation_") != -1)
            {
               if(_loc3_.hasOwnProperty(_loc5_))
               {
                  ...
                  {
                     _loc3_[_loc5_].adj = combined_gesture_stance_adjustment_objects(_loc4_[_loc5_].adj,_loc3_[_loc5_].adj);
                  }
                  for(_loc6_ in _loc4_[_loc5_])
                  {
                     if(_loc6_.indexOf("height_") != -1)
                     {
                        if(_loc3_[_loc5_].hasOwnProperty(_loc6_))
                        {
                           ...
                           {
                              _loc3_[_loc5_][_loc6_].adj = combined_gesture_stance_adjustment_objects(_loc4_[_loc5_][_loc6_].adj,_loc3_[_loc5_][_loc6_].adj);
                           }
                           for(_loc7_ in _loc4_[_loc5_][_loc6_])
                           {
                              if(_loc7_.indexOf("type_") != -1)
                              {
                                 if(_loc3_[_loc5_][_loc6_].hasOwnProperty(_loc7_))
                                 {
                                    ...
                                    {
                                       _loc3_[_loc5_][_loc6_][_loc7_].adj = combined_gesture_stance_adjustment_objects(_loc4_[_loc5_][_loc6_][_loc7_].adj,_loc3_[_loc5_][_loc6_][_loc7_].adj);
                                    }
                                 }
                                 else
                                 {
                                    ...
                                    {
                                       _loc3_[_loc5_][_loc6_][_loc7_].adj = combined_gesture_stance_adjustment_objects(_loc4_[_loc5_][_loc6_][_loc7_].adj,new Object());
                                    }
                                 }
                              }
                           }
                        ...
                        else
                        {
                           ...
                           {
                              _loc3_[_loc5_][_loc6_].adj = combined_gesture_stance_adjustment_objects(_loc4_[_loc5_][_loc6_].adj,new Object());
                           }
                        }
                     }
                  }
               ...
               else
               {
                  ...
                  {
                     _loc3_[_loc5_].adj = combined_gesture_stance_adjustment_objects(_loc4_[_loc5_].adj,new Object());
                  }
               }
            }
         }
         ...
         switch(param1)
         {
            ...
            case "legR":
               ...
               if(_loc6_ > _loc4_)
               {
                  ...
                  {
                     case "bicepL":
                        simple_bone_up("foreL");
                        break;
                     case "bicepR":
                        simple_bone_up("foreR");
                  }
      ...
      override protected function configure_incoming_pose(param1:Pose) : Pose
      {
         switch(_pose.type)
         {
            ...
            case PoseType.ACTION:
               ...
               {
                  case PoseType.NONE:
                     param1 = new Pose(CharLoader.pose_data["action"]["default"],pose_defaults);
                     break;
                  case PoseType.GESTURE:
                     param1 = combined_gesture_stance(param1,new Pose(CharLoader.pose_data["action"]["default"],pose_defaults),param1.name);
                     break;
                  case PoseType.STANCE:
                     param1 = combined_gesture_stance(new Pose(CharLoader.pose_data["action"]["default"],pose_defaults),param1,param1.name);
                     break;
                  case PoseType.ACTION:
                     param1 = param1;
               }
            ...
            case PoseType.COMBO:
               switch(param1.type)
               {
                  case PoseType.NONE:
                     ...
                     break;
                  case PoseType.GESTURE:
                     param1 = combined_gesture_stance(param1,_pose,param1.name);
                     break;
                  case PoseType.STANCE:
                     param1 = combined_gesture_stance(_pose,param1,param1.name);
                     break;
                  case PoseType.ACTION:
                     param1 = param1;
               }
      ...
      public function set action(param1:uint) : void
      {
         ...
         trace("POSE NAME: " + "p" + _action);
         var _loc3_:Object = _loc2_["action"]["p" + _action];
         if(!_loc3_)
         {
            _loc3_ = {
               "name":"p" + _action,
         ...
         _loc4_ = new Pose(_loc3_,pose_defaults);
         pose = _loc4_;
         dispatchEvent(new Event(Event.CHANGE));
      }
      ...
      public function set stance(param1:uint) : void
      {
         ...
         _stance = Math.min(9,Math.max(0,param1));
         var _loc2_:Object = CharLoader.pose_data;
         var _loc3_:String = "m" + _mode + "s" + _stance;
         ...
         _loc5_ = new Pose(_loc4_,pose_defaults);
         pose = _loc5_;
         dispatchEvent(new Event(Event.CHANGE));
      }
      ...
      public function align_arms() : void
      {
         ...
         while(_loc6_ < arms.length)
         {
            ...
            m.translate(_loc3_.x,_loc3_.y);
            _loc5_ = m.transformPoint(_loc5_);
            _loc1_.bones[0].set_position(_loc5_,_loc4_ + arms[_loc6_].starting_rot);
            _loc6_++;
         }
      }
      ...
      public function set gesture(param1:uint) : void
      {
         ...
         var _loc3_:Object = _loc2_["gesture"]["g" + _gesture];
         if(!_loc3_)
         {
            _loc3_ = {
               "name":"g" + _gesture,
         ...
         pose = new Pose(_loc3_,pose_defaults);
         dispatchEvent(new Event(Event.CHANGE));
      }
      ...
      private function filter_adjustment(param1:Object, param2:String) : Object
      {
         ...
         for(_loc3_ in param1)
         {
            ...
            {
               param1[_loc3_] = filter_adjustment_property(param1[_loc3_],param2);
            }
            for(_loc4_ in param1[_loc3_])
            {
               if(_loc4_.indexOf("height") != -1)
               {
                  param1[_loc3_][_loc4_] = filter_adjustment_property(param1[_loc3_][_loc4_],param2);
               }
               for(_loc5_ in param1[_loc3_][_loc4_])
               {
                  if(_loc5_.indexOf("type") != -1)
                  {
                     param1[_loc3_][_loc4_][_loc5_] = filter_adjustment_property(param1[_loc3_][_loc4_][_loc5_],param2);
                  }
               }
            }
         }
      ...
      private function combined_gesture_stance(param1:Pose, param2:Pose, param3:String) : Pose
      {
         ...
         _loc4_.angles = combined_gesture_stance_angles(param1.angles,param2.angles);
         _loc4_.adjustments = combined_gesture_stance_adjustments(param1.adjustments,param2.adjustments);
         ...
         return new Pose(_loc4_,pose_defaults);
      }
      
      public function setup_legs() : void
      {
         var _loc1_:uint = 0;
         while(_loc1_ < legs.length)
         {
            legs[_loc1_].bones[0].set_position(new Point(0,0),legs[_loc1_].starting_rot);
            _loc1_++;
         }
      }
      ...
      private function manage_skirt() : void
      {
         ...
         var _loc2_:Array = [skirt_mask];
         this.addChild(skirt_mask_test);
         skirt_mask_test.mouseChildren = false;
         skirt_mask_test.mouseEnabled = false;
      ...
      public function simple_bone_down(param1:String) : Boolean
      {
         ...
         switch(param1)
         {
            ...
            case "legR":
               break;
            case "foreL":
               simple_bone_down("bicepL");
               break;
            case "foreR":
               simple_bone_down("bicepR");
               break;
            default:
               return false;
         }
      ...
      override public function load_state(param1:Object) : void
      {
         ...
         if(param1.hasOwnProperty("mode"))
         {
            ...
            if(param1.mode == 3)
            {
               pose = new Pose(param1.pose,pose_defaults);
            }
            ...
            {
               gesture = param1.gesture;
               stance = param1.stance;
            }
         }
