package com.bitstrips
{
   ...
   public final class Utils
   {
      ...
      public static function remove_children(param1:DisplayObjectContainer) : void
      {
      ...
      public static function doubleclickable(param1:InteractiveObject) : void
      {
         param1.doubleClickEnabled = true;
         if(param1.parent)
         {
            Utils.doubleclickable(param1.parent);
         }
      }
      
      public static function alpha_trim(param1:BitmapData) : BitmapData
      {
