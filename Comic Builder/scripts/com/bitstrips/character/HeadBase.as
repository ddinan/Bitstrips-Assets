package com.bitstrips.character
{
   ...
   public class HeadBase extends MovieClip implements IHead
   {
      ...
      protected var _head_adjustment:Number = 0;
      ...
      {
         if(this.contains(this.head_back))
         {
            removeChild(this.head_back);
         }
         this.head_back = null;
      }
      ...
      public function get head_adjustment() : Number
      {
         return this._head_adjustment;
      }
