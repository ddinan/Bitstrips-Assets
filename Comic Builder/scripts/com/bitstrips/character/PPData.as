package com.bitstrips.character
{
   ...
   public class PPData
   {
      ...
      {
         this.mod = new Object();
         this.rmod = new Object();
         this.piece_data = new Object();
         super();
         this.piece_data["hat"] = {
            "type":"hat",
            "id":"_blank"
         };
         this.piece_data["glasses"] = {
            "type":"glasses",
            "id":"_blank"
         };
         this.piece_data["hair_front"] = {
            "type":"hair_front",
            "id":"_blank"
         };
         this.piece_data["brow_L"] = {
            "type":"brow",
            "id":"brow_art1"
         };
         this.piece_data["brow_R"] = {
            "type":"brow",
            "id":"brow_art1"
         };
         this.piece_data["nose"] = {
            "type":"nose",
            "id":"nose_art1"
         };
         this.piece_data["eyelash_L"] = {
            "type":"eyelash",
            "id":"_blank"
         };
         this.piece_data["eye_L"] = {
            "type":"eye",
            "id":"eye_art1"
         };
         this.piece_data["eyelid_L"] = {
            "type":"eyelid",
            "id":"eyelid_art1"
         };
         this.piece_data["pupil_L"] = {
            "type":"pupil",
            "id":"pupil_art1"
         };
         this.piece_data["eyelash_R"] = {
            "type":"eyelash",
            "id":"_blank"
         };
         this.piece_data["eye_R"] = {
            "type":"eye",
            "id":"eye_art1"
         };
         this.piece_data["eyelid_R"] = {
            "type":"eyelid",
            "id":"eyelid_art1"
         };
         this.piece_data["pupil_R"] = {
            "type":"pupil",
            "id":"pupil_art1"
         };
         this.piece_data["moustache"] = {
            "type":"moustache",
            "id":"_blank"
         };
         this.piece_data["mouth"] = {
            "type":"mouth",
            "id":"mouth_art1"
         };
         this.piece_data["detail_L"] = {
            "type":"detail_L",
            "id":"_blank"
         };
         this.piece_data["detail_R"] = {
            "type":"detail_L",
            "id":"_blank"
         };
         this.piece_data["detail_T"] = {
            "type":"detail_T",
            "id":"_blank"
         };
         this.piece_data["chin"] = {
            "type":"chin",
            "id":"_blank"
         };
         this.piece_data["cheek_L"] = {
            "type":"cheek",
            "id":"_blank"
         };
         this.piece_data["cheek_R"] = {
            "type":"cheek",
            "id":"_blank"
         };
         this.piece_data["forehead"] = {
            "type":"forehead",
            "id":"forehead_art1"
         };
         this.piece_data["cranium"] = {
            "type":"cranium",
            "id":"cranium_art1"
         };
         this.piece_data["earring_L"] = {
            "type":"earring",
            "id":"_blank"
         };
         this.piece_data["ear_L"] = {
            "type":"ear",
            "id":"ear_art1"
         };
         this.piece_data["earring_R"] = {
            "type":"earring",
            "id":"_blank"
         };
         this.piece_data["ear_R"] = {
            "type":"ear",
            "id":"ear_art1"
         };
         this.piece_data["goatee"] = {
            "type":"goatee",
            "id":"_blank"
         };
         this.piece_data["beard"] = {
            "type":"beard",
            "id":"beard_art1"
         };
         this.piece_data["jaw"] = {
         ...
         this.piece_data["hair_back"] = {
            "type":"hair_back",
            "id":"hair_back_art1"
         };
         this.piece_data["detail_E_L"] = {
            "type":"detail_E",
            "id":"_blank"
         };
         this.piece_data["detail_E_R"] = {
            "type":"detail_E",
            "id":"_blank"
         };
         if(BSConstants.KID_MODE)
         {
            this.piece_data["hair_front"]["id"] = "hair_front_art12";
            this.piece_data["forehead"]["id"] = "forehead_art5";
            this.piece_data["brow_L"]["id"] = "brow_art3";
            this.piece_data["brow_R"]["id"] = "brow_art3";
            this.piece_data["nose"]["id"] = "nose_art4";
            this.hairstyle = 11;
         }
         if(param1)
         {
      ...
      {
         return this.piece_data[param1]["id"];
      }
      
      public function get_art_type(param1:String) : String
      {
         return this.piece_data[param1]["type"];
      }
      ...
      public function set_art_id(param1:String, param2:String) : void
      {
         ...
         this.piece_data[param1]["id"] = param2;
      }
      ...
      public function save_data() : Object
      {
         ...
         for(_loc2_ in this.piece_data)
         {
            _loc1_["piece_data"][_loc2_] = [_loc2_,this.piece_data[_loc2_]["type"],this.piece_data[_loc2_]["id"]];
         }
         _loc1_["mod"] = new Object();
         for(_loc2_ in this.mod)
         {
            _loc1_["mod"][_loc2_] = this.mod[_loc2_];
         }
         _loc1_["hairstyle"] = this.hairstyle;
         _loc1_["beardstyle"] = this.beardstyle;
         _loc1_["backstyle"] = this.backstyle;
         return _loc1_;
      }
      ...
      public function load_data(param1:Object) : Boolean
      {
         ...
         for(_loc2_ in param1["piece_data"])
         {
            ...
            this.set_art_id(_loc3_[0],_loc3_[2]);
         }
         for(_loc2_ in param1["mod"])
         {
            this.mod[_loc2_] = param1["mod"][_loc2_];
         }
         this.hairstyle = param1["hairstyle"];
         this.beardstyle = param1["beardstyle"];
         if(param1["backstyle"] != undefined)
         {
            this.backstyle = param1["backstyle"];
         }
         return true;
      }
      ...
      public function get_mod(param1:String, param2:Number) : Object
      {
         ...
         if(this.mod[param1])
         {
            if(this.mod[param1][param2])
            {
               _loc4_ = this.mod[param1][param2];
               _loc3_.x = _loc4_.x;
               _loc3_.y = _loc4_.y;
               _loc3_.xs = _loc4_.xs;
               _loc3_.ys = _loc4_.ys;
      ...
      public function get_rmod(param1:String, param2:Number, param3:Number) : Object
      {
         ...
         var _loc4_:Object = this.get_mod(param1,param2);
         if(param3 > 1)
         {
            if(this.rmod[param1])
            {
               if(this.rmod[param1][param2])
               {
                  if(this.rmod[param1][param2][param3])
                  {
                     _loc5_ = this.rmod[param1][param2][param3];
                     _loc4_.x = _loc5_.x;
                     _loc4_.y = _loc5_.y;
                     _loc4_.xs = _loc5_.xs;
                     _loc4_.ys = _loc5_.ys;
      ...
      {
         var _loc5_:Object = this.get_base(param1,param2,param4);
         var _loc6_:Object = this.get_rmod(param1,param2,param3);
      ...
      {
         this.mod[param1] = new Array();
         this.rmod[param1] = new Array();
      }
      
      public function set_mod(param1:String, param2:Object, param3:uint, param4:uint, param5:uint) : void
      {
         var _loc8_:int = 0;
         var _loc6_:Object = this.get_base(param1,param3,param5);
         var _loc7_:Object = {
            "x":param2.x - _loc6_.x,
            "y":param2.y - _loc6_.y,
         ...
         if(this.mod[param1] == undefined)
         {
            this.mod[param1] = new Array();
            _loc8_ = 0;
            while(_loc8_ < 8)
            {
               this.mod[param1][_loc8_] = {
                  "x":_loc7_.x,
                  "y":_loc7_.y,
                  "xs":_loc7_.xs,
                  "ys":_loc7_.ys
         ...
         if(param4 > 1)
         {
            if(this.rmod[param1] == undefined)
            {
               this.rmod[param1] = new Array();
            }
            if(this.rmod[param1][param3] == undefined)
            {
               this.rmod[param1][param3] = new Array();
            }
            this.rmod[param1][param3][param4] = _loc7_;
         }
         else
         {
            this.mod[param1][param3] = {
               "x":_loc7_.x,
               "y":_loc7_.y,
               "xs":_loc7_.xs,
               "ys":_loc7_.ys
            ...
            while(_loc8_ < 8)
            {
               if(this.mod[param1][_loc8_] == undefined)
               {
                  this.mod[param1][_loc8_] = new Object();
               }
               this.mod[param1][_loc8_].xs = _loc7_.xs;
               this.mod[param1][_loc8_].y = _loc7_.y;
               this.mod[param1][_loc8_].ys = _loc7_.ys;
               _loc8_ = _loc8_ + 1;
            }
         }
      }
